<template>
  ...
  >
    <v-card-text>
      <h2 style="color:pink; font-weight: bold; font-size:200%;">| Health</h2>
    </v-card-text>
        ...
        >
         <v-img
          ...
          >
            ...
            <div class="font-weight-light pink--text" v-text="data.title" size="5"></div>
...
<script>
  ...
  export default {
    ...
    methods: {
      load(){
        axios.get('https://newsapi.org/v2/top-headlines?apikey=6bc3cbc8dcf3473fb2527028734aedee&country=id&category=health')
        .then(res => {
